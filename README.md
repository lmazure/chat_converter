...
## Use Google Takeout to retrieve your chats
...
2) Navigate in it and look for the folder containing the workspace (if the URL of the workspace is `https://mail.google.com/chat/u/0/#chat/space/AAAA2mKCqoY`, then the folder is `Takeout/Google Chat/Groups/Space AAAA2mKCqoY`).
